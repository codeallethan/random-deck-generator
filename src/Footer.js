...
export const Footer = (props) => {
    ...
    return (
        <div className={'footer'}>
            ...
            <Header size={'small'} inverted>Fan Content Policy</Header>
            <span>
            ...
            <p><a href={'http://www.supercell.com/fan-content-policy'} target={'_blank'}>Supercell’s Fan Content
                Policy</a></p>
                        <Divider />
                        Icon (Dice) made by <a href={'https://www.flaticon.com/authors/dimi-kazak'} target={'_blank'}>Dimi Kazak</a> from www.flaticon.com
                    </Grid.Column>
                    <Grid.Column width={3}>
                        <Icon className={'.icon'} inverted size={'big'} name={'github'} />
                        <Icon inverted className={'.icon'} size={'big'} name={'twitter'} />
                        <Icon inverted  className={'.icon'} size={'big'} name={'instagram'} />
                    </Grid.Column>
                </Grid.Row>
            </Grid>
        </div>
